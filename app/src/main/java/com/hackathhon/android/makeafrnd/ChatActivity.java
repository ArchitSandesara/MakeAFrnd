...
import com.hackathhon.android.makeafrnd.Messages.MessageAdapter;
import com.hackathhon.android.makeafrnd.Messages.MessageDialog;
import com.hackathhon.android.makeafrnd.Messages.MessageObject;
import com.hackathhon.android.makeafrnd.Tasks.ImageCompressAsyncTask;
import com.hackathhon.android.makeafrnd.Users.UserAdapter;
import com.hackathhon.android.makeafrnd.Users.UserObject;
...
public class ChatActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.layout.activity_chat);
        ...
        avatar = intent.getStringExtra(MainActivity.AVATAR);
        sCurrentUser = new UserObject(username, avatar);
        ...
        mRootContainer = (RelativeLayout) findViewById(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.id.root_view);
        ...
        if (mSelectedImages != null) {
            if (!mSelectedImages.isEmpty()) {
                ...
                for (Image image : mSelectedImages) {
                    ...
                    mSubmitButton.setImageDrawable(ContextCompat.getDrawable(getApplicationContext(), com.hackathhon.android.makeafrnd.bottomsheetpicker.R.drawable.ic_loop_light));
                    ...
                    String[] params = { image.getPath(), username, avatar, ImageCompressAsyncTask.TRUE };
    ...
    private void setUpUsersViews(){
        ...
        RecyclerView mUsersRecyclerView = (RecyclerView) findViewById(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.id.users_list);
    ...
    private void setUpMessagesViews(){
        ...
        RecyclerView mMessagesRecyclerView = (RecyclerView) findViewById(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.id.messages_list);
    ...
    private void setUpMessageSendViews() {
        ...
        ImageView mEmojiButton = (ImageView) findViewById(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.id.text_emoji_button);
        ImageView mImagePickerButton = (ImageView) findViewById(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.id.text_entry_image_button);
        mTextField = (EmojiconEditText) findViewById(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.id.text_entry_field);
        mSubmitButton = (ImageButton) findViewById(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.id.message_send_button);
        ...
        mSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!messageBody.isEmpty() && !messageBody.matches("^(\\s+)$")){
                    ...
                    publishMessage(new MessageObject(username, messageBody, MessageObject.MESSAGE_CONTENT_TEXT, avatar, true));
                    ...
                    showSnackbar(getString(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.string.error_empty_message));
                }
            }
        });
    }
                    ...
                    public void onResult(@NonNull Status status) {
                        if (status.isSuccess()) {
                            ...
                            if (mImagesBeingSent){
                                ...
                                showSnackbar(getApplicationContext().getString(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.string.message_image_send_in_progress));
                                mImagesBeingSent = false;
                            } else {
                                // Otherwise, just show the stock connection successful message.
                                showSnackbar(getApplicationContext().getString(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.string.nearby_subscription_success));
                            }
                        } else {
                            // Unsuccessfully subscribed, notify the user.
                            showSnackbar(getApplicationContext().getString(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.string.nearby_subscription_failed));
                        }
                    }
                });
    }
                ...
                .setResultCallback(new ResultCallback<Status>() {
                    ...
                    public void onResult(@NonNull Status status) {
                        if (status.isSuccess()){
                            ...
                            showSnackbar(MainActivity.mainContext.getString(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.string.nearby_publish_message_failed));
                        }
                        ...
                        mSubmitButton.setImageDrawable(ContextCompat.getDrawable(MainActivity.mainContext, com.hackathhon.android.makeafrnd.bottomsheetpicker.R.drawable.ic_send_light));
                    }
                });
    }
    ...
    private void addUserToUsersContainer(UserObject userObject){
        ...
        RecyclerView usersList = (RecyclerView) mRootContainer.findViewById(com.hackathhon.android.makeafrnd.bottomsheetpicker.R.id.users_list);
        usersList.setBackgroundColor(ContextCompat.getColor(getApplicationContext(), com.hackathhon.android.makeafrnd.bottomsheetpicker.R.color.messageUsersField));
    }
